...
- [Promise.all 병렬 vs 순차 await](knowledge/concepts/promise-all-vs-sequential.md) — 순차 await는 tA+tB+tC, Promise.all은 max — 병렬성은 "출발 시점(in-flight)"에서, I/O 겹치기일 뿐 계산 병렬화 아님 · frontend · mastery 4/5 · importance 4/5
