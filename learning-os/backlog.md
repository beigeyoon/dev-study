...
- [ ] **수평 확장 / 로드밸런서 / SPOF** — (importance 4, 🚪 **system-design 영역 개방 후보.** 오늘 앵커에서 자력으로 다룬 것들의 제 집. "서버를 늘린다"가 정확히 뭘 의미하나, LB가 요청을 어떻게 나누나, 단일 장애점을 어떻게 없애나(복제·클러스터). 백엔드·DevOps로 가는 관문)
